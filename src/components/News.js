        ...
        return (
            <>
                <div  className="my-4 container text-center">
                    <div style={{ rowGap: "3rem" }} id="gridLayout" className=" ">
                        <div className="col">
                            <NewsItem
                        ...
                        <div className="col">
                            <NewsItem
                                ...
                                content="Vittima di un’aggressione definita &#8220;selvaggia&#8221; da parte del suo ex compagno, una professoressa di una scuola di Prato salvata da tre stranieri che si trovavano a passare dal parcheggio del centro commerciale Parco Prato dove si stava consumando la violenza. Il presunto responsabile"
                            />
                        </div>
                        <div className="col">
                            <NewsItem
